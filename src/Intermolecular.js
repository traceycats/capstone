export default function Intermolecular() {
    return (
          <div class="lesson">
          <h2>intermolecular - the social life of a molecule</h2>
          <p>intermolecular forces are the different ways separate molecules interact with each other. there are several different types of intermolecular forces:</p>
                    ...
                    <li>dipole dipole</li>
                        <ul><li>dipole dipole interactions come from electrical interactions among dipoles, they can be attractive or repulsive</li></ul> 
                    <li>ion-dipole</li>
